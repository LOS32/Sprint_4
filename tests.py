...
class TestBooksCollector:
   ...
   # Тест для валидных граничных значений (39 и 40 символов)
...
# Попытка удалить книгу, которой нет в избранном
   ...
   # Добавляем книги в избранное и затем удаляем их
   def test_remove_books_from_favorites_updates_list(self, collector):
       collector.add_new_book('Гордость и предубеждение и зомби')
       collector.add_new_book('Что делать, если ваш кот хочет вас убить')
       collector.add_book_in_favorites('Гордость и предубеждение и зомби')
       collector.add_book_in_favorites('Что делать, если ваш кот хочет вас убить')
